...
let website = "/SyntacticVersioning"

let githubLink = "https://github.com/fsprojects/SyntacticVersioning"

// Specify more information about your project
let info =
  [ "project-name", "SyntacticVersioning"
    "project-author", "Oskar Gewalli; SPISE MISU ApS (Ramón Soto Mathiesen)"
    "project-summary", "Syntactic (Semantic) Versioning for .NET libraries heavily inspired in elm-package (bump and diff)"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/SyntacticVersioning" ]
